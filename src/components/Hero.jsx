      ...
      {/* Left side content */}
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start lg:pl-16'>
            ...
            <div className='px-2'> 
  <a href='https://drive.google.com/drive/u/0/folders/14IqyWbmy8-ZPESJSnGxH_FVMXpNzVvZk' target='_blank'> 
    <motion.button 
      variants={container(1.5)}
      initial="hidden"
      animate="visible" 
      ...
      My Achievements
        ...
        <div className='w-full lg:w-1/2 lg:p-3'>
          <div className='flex justify-center lg:justify-end'>
            ...
            src={profilePic} alt="Divjot Singh" className='max-w-xs lg:max-w-md h-auto rounded-2xl  cursor-pointer  hover:scale-110'></motion.img>
          </div>
        </div>
      </div>
    </div>
